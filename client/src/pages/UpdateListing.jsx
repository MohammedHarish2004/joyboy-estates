...
export default function CreateListing() {
  ...
  return (
    <main className='p-2 max-w-5xl mx-auto'>
      <h1 className='text-3xl font-bold text-center mt-5 mb-6'>Update Listing</h1>
      ...
      <form className='flex flex-col sm:flex-row gap-4' onSubmit={handleSubmit}>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 font-semibold'>{loading ? 'Updating...' : 'Update Listing' }</button>
        </div>
